            ...
            <div class="card">
              <div class="card-header">Libros</div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="formulario-control" name="autor" value="{{$libro->autor}}" id="autor" placeholder="autor" required>
                    </div>
                </div>
                <div class="row mb-3">
                  <label for="genero" class="col-md-4 col-form-label text-md-end">Genero</label>
                  <div class="col-md-6">
                      <input type="text" class="formulario-control" name="genero" id="genero"
