            ...
            <div class="card">
              <div class="card-header">Proovedor</div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="formulario-control" name="nombre" id="nombre" placeholder="nombre"  required> 
                    </div>
                </div>
                <div class="row mb-3">
              ...
              <div class="row mb-3" id="grupo-nit">
                ...
                <div class="col-md-6">
                    <input type="text" class="formulario-control" name="nit" id="nit" placeholder="nit" required>
                </div>
             </div>
                     <div class="row mb-0">
